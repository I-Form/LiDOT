function [varargout]=abaqusStruct2inpBMcD(varargin)
...
%------------------------------------------------------------------------
% Modified by B McDonnell to include more fields in fieldOrder
...
defaultOptionStruct.fieldOrder={'heading','preprint','part','node','element',...
                                ...
                                'assembly','Amplitude','distribution_table','Section_Controls','material','Depvar',...
